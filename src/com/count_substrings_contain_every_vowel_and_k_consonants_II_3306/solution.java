package com.count_substrings_contain_every_vowel_and_k_consonants_II_3306;
import java.util.*;
public class solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter integer number of k consonants");
        int k = sc.nextInt();
        long l = new solution().countOfSubstring(word, k);
